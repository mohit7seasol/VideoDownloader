...
let languages = [
    ...
    AppLanguage(LocalName: "日本語", image: .japanese, englishName: "Japanese", languageCode: .Japanese),
    AppLanguage(LocalName: "Русский", image: .russian, englishName: "Russian", languageCode: .Russian)
]
